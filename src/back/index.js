        ...
        switch (municipe.step) {
            case 0://entrou em contato pela primeira vez
                await client.sendMessage(numeroDoMunicipe,
                    ...
                    `Seu problema é relacionado a algum dos tópicos abaixo?\n` +
                    `1 - Capina\n` +
                    `2 - Buraco\n` +
            ...
            case 1://valida se ja fez contato com a secretaria
                ...
                if (tag != null) {
                    municipe.tag = tag;
                    await client.sendMessage(numeroDoMunicipe, `Já foi feito contato com a secretaria?`);
                    municipe.step = 2;
                }
                break;
            ...
            case 7://pega o endereço
                ...
                break;
            case 8://pega a descrissão do problema
...
async function validarProtocolo(msg) {
    if (1 == 1) {//verificar o que precisa para validar protocolo
        return msg.body;
    } else {
        return null;
    }
...
async function validarDataAbertura(msg) {
    if (1 == 1) {//verificar o que precisa para validar data de abertura do protocolo
        return msg.body;
    } else {
        return null;
    }
...
async function validarPrazo(msg) {
    if (1 == 1) {//verificar o que precisa para validar prazo
        return msg.body;
    } else {
        return null;
    }
...
async function validarEmail(msg) {
    if (1 == 1) {//verificar o que precisa para validar email
        return msg.body;
    } else {
        return null;
    }
